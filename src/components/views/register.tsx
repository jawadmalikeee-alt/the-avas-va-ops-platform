  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-6 py-12">
      <div className="w-full max-w-sm">
        ...
        {/* Google signup (UI only — needs OAuth config for production) */}
        <Button variant="outline" className="w-full h-12 rounded-full text-sm" onClick={() => setError('Google sign-up requires OAuth configuration. Please use email/password.')}>
